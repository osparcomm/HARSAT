...
```{r sed_setup, include = FALSE}

# default

wk_data_format <- "old"

# overwrite if specified in call
...
```{r sed_metcx1, eval = wk_data_format == "old"}
...
Fortunately, most of these are for organics, for which method_extraction isn't used. So replace e.g. ACH~PLE by ACE etc. 
...
```{r sed_metcx2, eval = wk_data_format == "old"}
