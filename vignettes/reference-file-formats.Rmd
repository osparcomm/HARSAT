...
| ------------- | --------- | :-------: | :--------: | --------------------- |
| `determinand` | character | yes | no | The determinand code, which must key to the determinands file |
| `species_group` | character | yes | The species group, a key to the `species.csv` file |
| `species_subgroup` | character | yes | The species subgroup, a key to the `species.csv` file |
